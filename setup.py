...
setup(name='docassemble.RFApackage',
      ...
      install_requires=['docassemble.ALToolbox @ git+https://github.com/suffolklitlab/docassemble-ALToolbox.git@main', 'docassemble.AssemblyLine>=4.6.0', 'docassemble.GithubFeedbackForm>=0.5.6', 'docassemble.VTFeedback @ git+https://github.com/LSVermont/docassemble-VTFeedback.git@main'],
      zip_safe=False,
